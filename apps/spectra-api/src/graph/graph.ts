...
export const spectraGraph = new StateGraph(SpectraStateAnnotation)
  ...
  .addNode(
    "documentNode",
    documentNode as unknown as (state: SpectraState) => Promise<Partial<SpectraState>>,
  )
  .addNode(
    "visionNode",
    visionNode as unknown as (state: SpectraState) => Promise<Partial<SpectraState>>,
  )
  .addNode(
    "audioNode",
    audioNode as unknown as (state: SpectraState) => Promise<Partial<SpectraState>>,
  )
